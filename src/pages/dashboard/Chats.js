...
import { Box, IconButton, Stack, Typography, InputBase, Button, Divider, Avatar } from '@mui/material'
...
const Chats = () => {
  ...
  return (
    <Box sx={{position: "relative", width: "320px", backgroundColor: theme.palette.mode === "light" ? "#F8FAFF" : theme.palette.background.paper, boxShadow: "0px 0px 2px 0px rgba(0, 0, 0, 0.25)" }}>
          ...
          <Stack sx={{flexGrow: 1, overflow: "auto", height: "100%" }}>
            <SimpleBarStyle timeout={500} clickOnTrack={false}>
              <Stack spacing={2.4}>
                ...
                {ChatList.filter((el) => el.pinned).map((el) => {return <ChatElement {...el} />})}
              </Stack>
              <Stack spacing={2.4}>
