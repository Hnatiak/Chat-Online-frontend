...
const Conversation = () => {
  ...
  return (
    <Stack height={"100%"} maxHeight={"100vh"} width={"auto"}>
        {/* Chat Header */}
        <Box p={2} sx={{width: "100%", backgroundColor: theme.palette.mode === 'light' ? "#F8FAFF" : theme.palette.background.paper, boxShadow: "0px 0px 2px 0px rgba(0, 0, 0, 0.25)"}}>
            <Stack alignItems="center" direction="row" justifyContent="space-between" sx={{width: "100%", height: "100%"}}>
                <Stack direction="row" spacing={2}>
                    ...
                    <Stack spacing={0.2}>
                        <Typography variant='subtitle2'>{faker.name.firstName()}</Typography>
