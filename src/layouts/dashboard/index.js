          ...
          <Stack alignItems={"center"} spacing={4}>
            ...
            <Stack sx={{width: "max-content"}} direction="column" alignItems="center" spacing={2}>
              {Nav_Buttons.map((el) => (
                ...
                :
                <IconButton onClick={() => {setSelected(el.index)}} sx={{width: "max-content", color: theme.palette.mode === "light" ? "#080707" : theme.palette.text.primary}} key={el.index}>{el.icon}</IconButton>
              ))}
              ...
              {selected === 3 ? 
                (
                  ...
                  <IconButton onClick={() => {setSelected(3);}} sx={{width: "max-content", color: theme.palette.mode === "light" ? "#080707" : theme.palette.text.primary}}>
                    <Gear />
                  </IconButton>
                )
              }
